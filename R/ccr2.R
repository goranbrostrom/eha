...
#' @param center Logical. If \code{center = TRUE} (default), the baseline
#' hazards are calculated at the means of the covariates and for the reference
#' category for factors, otherwise at the value zero. See Details.
#' @param x Return the design matrix in the model object?
#' @param y return the response in the model object?
#' @param hazards Calculate baseline hazards? Default is TRUE.
#' @param rs Risk set?
...
#' baseline hazard, calculated at the means of the covariates (rather, columns
#' of the design matrix). Is a list, with one component per stratum. Each
#' component is a matrix with two columns, the first contains risktimes, the
#' second the corresponding hazard atom.} \item{means}{Means of the columns of
...
#' \item{formula}{The calling formula.} \item{bootstrap}{The (matrix of)
#' bootstrap replicates, if requested on input. It is up to the user to do
#' whatever desirable with this sample.} \item{boot.sd}{The estimated standard
#' errors of the bootstrap replicates.} \item{call}{The call.}
