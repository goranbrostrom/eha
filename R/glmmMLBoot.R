...
#' 
#' 
#' @param X The design matrix (n * p).
#' @param Y The response vector of length n.
#' @param weights Case weights.
#' @param start.coef start values for the parameters in the linear predictor
...
#' \code{cloglog} links.
#' @param control A list. Controls the convergence criteria. See
...
#' coefficients (note: No intercept).} \item{logLik}{The maximised log
#' likelihood.} \item{cluster.null.deviance}{deviance from a moddel without
#' cluster.} \item{frail}{The estimated cluster effects.} \item{bootLog}{The
#' maximised bootstrap log likelihood values. A vector of length \code{boot}.}
#' \item{bootP}{The bootstrap p value.} \item{variance}{The variance-covariance
#' matrix of the fixed effects (no intercept).} \item{sd}{The standard errors
#' of the \code{coefficients}.} \item{boot_rep}{The number of bootstrap
#' replicates.}
#' @note A profiling approach is used to estimate the cluster effects.
